...
<div class="row mb-4 bx-<?= $arParams["TEMPLATE_THEME"] ?>">
        ...
        <div class="col-lg-3 col-md-4 col-sm-5<?= (isset($arParams['FILTER_HIDE_ON_MOBILE']) && $arParams['FILTER_HIDE_ON_MOBILE'] === 'Y' ? ' d-none d-sm-block' : '') ?>">
            ...
            if ($isFilter): ?>
                <div class="bx-sidebar-block">
                    <?
                    $APPLICATION->IncludeComponent("bitrix:catalog.smart.filter", "bootstrap_v4", [
    ...
    <div class="pb-4 <?= (($isFilter || $isSidebar) ? "col-lg-9 col-md-8 col-sm-7" : "col") ?>">
        ...
        // ÇÄÅÑÜ ÊÀÑÒÎÌÈÇÈÐÎÂÀÍÍÛÉ ØÀÁËÎÍ - bootstrap_v4_ajaxnav
        $intSectionID = $APPLICATION->IncludeComponent(
            "bitrix:catalog.section",
            "bootstrap_v4_ajaxnav",
            [
                 // ïåðåäà÷à êîíòåêñòà
                'BXMAKER_AJAXPAGENAV_CONTEXT_NAME' => $arParams['BXMAKER_AJAXPAGENAV_CONTEXT_NAME'],

...
<div class="row<?=$themeClass?>"> <? // wrapper ?>
	...
	//endregion
	?>
		<div class="mb-4 catalog-section <?=(!empty($ajaxPagenavContext) ? $ajaxPagenavContext->getBlockClassName('content') : '');?> " data-entity="<?=$containerName?>">
            <!-- items-container -->
		...
		if ($showBottomPager)
		{
			?>
			<div class="row mb-4">
				<div class="col text-center <?=(!empty($ajaxPagenavContext) ? $ajaxPagenavContext->getBlockClassName('navbottom') : '');?>" data-pagination-num="<?=$navParams['NavNum']?>">
					<!-- pagination-container -->

...
?>
<?
// шаблон каталога предварительно скопирован с новым названием - bootstrap_v4_ajaxnav
$APPLICATION->IncludeComponent("bitrix:catalog", "bootstrap_v4_ajaxnav", [

	//	указываем свой шаблон постраничной навигации
	"PAGER_TEMPLATE" => "bxmaker_ajaxpagenav_default",    // Шаблон постраничной навигации
	// доп парамтер, для контекста подгруки данных
	"BXMAKER_AJAXPAGENAV_CONTEXT_NAME" => "catalog_section",    // Шаблон постраничной навигации
	...
	"BASKET_URL" => "/ee/personal/cart/",    // URL, ведущий на страницу с корзиной покупателя
	...
	"SEF_FOLDER" => "/ee/catalog/",    // Каталог ЧПУ (относительно корня сайта)
	...
	"DETAIL_OFFERS_PROPERTY_CODE" => [    // Свойства предложений
		0 => "ARTNUMBER",
		1 => "SIZES_SHOES",
		2 => "SIZES_CLOTHES",
		3 => "COLOR_REF",
	...
	"STORE_PATH" => "/ee/store/#store_id#",    // Шаблон пути к каталогу STORE (относительно корня)
	...
	"SIDEBAR_PATH" => "/ee/catalog/sidebar.php",    // Путь к включаемой области для вывода информации в боковой панели
	"SEF_URL_TEMPLATES" => [
		"sections" => "",
